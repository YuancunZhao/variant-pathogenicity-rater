...
def parse_literature_record(
    ...
    claims = [
        _parse_claim(raw_claim, study_id=study_id, citation=citation, fallback_quality=quality)
...
def map_literature_claim_to_candidate_evidence(
    ...
    for code in claim.candidate_codes:
        items.append(
            EvidenceItem(
...
def _parse_claim(
    ...
    *,
    ...
    return LiteratureClaim(
        ...
        candidate_codes=[EvidenceCode(code) for code in raw_claim.get("candidate_codes", [])],
